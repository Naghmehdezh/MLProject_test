...
if __name__ == "__main__":
  ...
  data_path="https://raw.githubusercontent.com/Naghmehdezh/MLProject_test/master/aligned_dataset.csv"
  #data_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "aligned_dataset.csv")
  train_df = pd.read_csv(data_path, parse_dates=[6])
  #print(train_df.head())
  ...
  with mlflow.start_run():
    ...
    for i in range(1,k):
      ...
      FBProphet_model = Prophet(yearly_seasonality=20)
      FBProphet_model.fit(sales_per_date)
      mlflow.log_param("yearly_seasonality" , 10)
